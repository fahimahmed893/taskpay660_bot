...
ADMIN_TELEGRAM_ID = 123456789          # আপনার নিজের Telegram numeric ID (@userinfobot দিয়ে বের করুন)
ADMIN_SECRET_PATH = "changeme-secret"  # এডমিন প্যানেলের গোপন অংশ, url এ থাকবে
